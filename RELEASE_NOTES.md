...
**Обновление Windows-клиента:** файл `windows-ashaos-1.7.exe` пересобран из
коммита `22c6b73`. В нём исправлено возобновление звука после тишины и
коротких пауз захвата; новая сборка Android для этой правки не требуется.
